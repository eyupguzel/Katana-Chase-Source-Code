...
public class Attack3 : IMeleeAttack
{
    public IPlayerState AttackState { get; private set; }

    public AttackDataSO AttackData { get; private set; }

    public Attack3(AttackDataSO attack1Data, Rigidbody2D rb, Animator animator, PlayerStateMachine playerStateMachine, IPlayerInputService input)
    {
        AttackData = attack1Data;
        AttackState = new Attack_3_State(rb, animator, playerStateMachine, input);
    }
