...
public class Attack1 : IMeleeAttack
{
    public IPlayerState AttackState { get; private set; }

    public AttackDataSO AttackData { get; private set; }

    public Attack1(AttackDataSO attack1Data,Rigidbody2D rb, Animator animator,PlayerStateMachine playerStateMachine, IPlayerInputService input)
    {
        AttackData = attack1Data;
        AttackState = new Attack_1_State(rb,animator ,playerStateMachine, input);
    }
