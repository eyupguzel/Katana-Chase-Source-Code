...
public class SpecialAttack : IMeleeAttack
{
    public SpecialAttack(AttackDataSO specialAttackData, Rigidbody2D rb, Animator animator, PlayerStateMachine playerStateMachine, IPlayerInputService input)
    {
        AttackData = specialAttackData;
        AttackState = new Special_State(rb, animator, playerStateMachine, input);
    }
